...
<body>
    <div class="container">
        ...
        <form action="{url controller='client' action='addCreditCard'}" method="POST"> {* Sostituisce action="/Pancia_mia_fatti_capanna/client/addCreditCard" con la funzione Smarty 'url' *}
