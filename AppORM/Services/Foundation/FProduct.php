...
class FProduct 
{
    ...
    public static function saveObj(EProduct $product): bool {
         return FEntityManager::getInstance()->saveObject($product); 
    }
    ...
    public static function setAvailability(EProduct $product, bool $availability): bool {
         $product->setAvailability($availability); return self::saveObj($product); 
    }

    public static function deleteObj(EProduct $product): bool {
         return FEntityManager::getInstance()->deleteObject($product); 
    }
    ...
    public static function fetchAll(): array{
         return FEntityManager::getInstance()->selectAll(EProduct::class);
    }
