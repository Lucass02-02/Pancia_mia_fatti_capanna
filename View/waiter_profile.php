<?php
// File: View/waiter_profile.php (AGGIORNATO CON CSS E LINK)
/** @var \AppORM\Entity\EWaiter $waiter */
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Cameriere - <?php echo htmlspecialchars($waiter->getName()); ?></title>
    <style>
...
<body>
    <div class="container">
        <h1>Ciao, <?php echo htmlspecialchars($waiter->getName()); ?>!</h1>

        <div class="dashboard">
            <div class="dashboard-item">
                <h3>Le Tue Informazioni</h3>
                <p><strong>Matricola:</strong> <?php echo htmlspecialchars($waiter->getSerialNumber()); ?></p>
                <p><strong>Sala Assegnata:</strong> <?php echo htmlspecialchars($waiter->getRestaurantHall()->getName()); ?></p>
            </div>
            <div class="dashboard-item">
