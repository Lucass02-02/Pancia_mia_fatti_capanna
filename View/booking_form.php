...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <form action="/GitHub/Pancia_mia_fatti_capanna/index.php?c=reservation&a=book" method="POST">
            <div class="form-grid">
        ...
        <nav><a href="/GitHub/Pancia_mia_fatti_capanna/index.php?c=client&a=profile">Torna al Profilo</a></nav>
    </div>
</body>
</html>